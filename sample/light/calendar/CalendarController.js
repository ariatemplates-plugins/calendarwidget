(function () {
    ...
    Aria.classDefinition({
        $classpath : basePath + "calendar.CalendarController",
        $dependencies : ["aria.utils.Date", "aria.utils.environment.Date", "aria.utils.Array", "aria.utils.Json",
                basePath + "calendar.CalendarCfgBeans"],
        $events : {
            "focusChanged" : {
        ...
        /**
         * @param {aria.widgets.calendar.CfgBeans.CalendarModel}
         */
        $constructor : function (data) {

            /**
             * Shortcut to the json utility
        ...
        $prototype : {
            ...
            init : function (data, cb) {
                ...
                aria.core.JsonValidator.normalize({
                    ...
                    beanName : basePath + "calendar.CalendarCfgBeans.Properties"
                });
                this.update();
                this._jsonListener = {
