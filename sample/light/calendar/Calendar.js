(function () {
    ...
    Aria.classDefinition({
        $classpath : basePath + "calendar.Calendar",
        $extends : "aria.html.Element",
        $dependencies : [basePath + "calendar.CalendarController", basePath + "calendar.CalendarCfgBeans",
                "aria.html.Template", "aria.utils.Object", "aria.utils.Array", basePath + "calendar.CalendarSkin"],
        $css : ["light.calendar.CalendarStyle"],
        $constructor : function (cfg, context, lineNumber) {

            this.$cfgBean = basePath + "calendar.CalendarCfgBeans.Properties";
             ...
             * @type light.calendar.CalendarController
             */
